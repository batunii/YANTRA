...
class IndexCostTest {
    ...
    private fun report(label: String, pages: Int, tasks: Int, inkBlocks: Int, strokes: Int): Unit = runBlocking {
        ...
        var idx: ie.shoonya.yantra.data.workspace.WorkspaceIndex? = null
        repeat(runs) {
            idx = ie.shoonya.yantra.data.workspace.WorkspaceReconciler.read(store, System.currentTimeMillis())
        }
