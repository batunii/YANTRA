...
import ie.shoonya.yantra.ui.AppNav
import ie.shoonya.yantra.ui.OpenTarget
import ie.shoonya.yantra.ui.theme.LocalThemeController
...
class MainActivity : ComponentActivity() {
     ...
     * service only fires on [ie.shoonya.yantra.domain.FocusTimer] *transitions*, and a restore
