...
object LauncherIcon {
    ...
    private fun aliasFor(accent: AccentColor): String = when (accent) {
        AccentColor.CORAL -> "ie.shoonya.yantra.LaunchCoral"
        AccentColor.JADE -> "ie.shoonya.yantra.LaunchJade"
        AccentColor.AZURE -> "ie.shoonya.yantra.LaunchAzure"
        AccentColor.INDIGO -> "ie.shoonya.yantra.LaunchIndigo"
        AccentColor.ORCHID -> "ie.shoonya.yantra.LaunchOrchid"
    }
