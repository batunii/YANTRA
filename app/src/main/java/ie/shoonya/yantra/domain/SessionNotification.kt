...
import ie.shoonya.yantra.widget.WidgetIntents
...
object SessionNotification {
    ...
    const val ACTION_STOP = "ie.shoonya.yantra.action.SESSION_STOP"
    const val ACTION_DONE = "ie.shoonya.yantra.action.SESSION_DONE"
    const val ACTION_PAUSE = "ie.shoonya.yantra.action.SESSION_PAUSE"
    const val ACTION_RESUME = "ie.shoonya.yantra.action.SESSION_RESUME"
     ...
     */
    const val EXTRA_NODE_ID = "ie.shoonya.yantra.SESSION_NODE_ID"
     ...
     * died and [ie.shoonya.yantra.widget.FocusFinalizeWorker] closed the row later — reported
