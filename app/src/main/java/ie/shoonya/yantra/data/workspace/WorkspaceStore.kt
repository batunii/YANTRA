...
class WorkspaceStore(
    ...
    companion object {
         ...
         *
         * 2 since ink coordinates became document units ([ie.shoonya.yantra.data.ink.PAGE_WIDTH_DU])
         * and strokes moved into Yantra's own envelope ([ie.shoonya.yantra.data.ink.StrokeEnvelope]).
         *
