 ...
 *
 * Deliberately not a mock of the client. Everything that goes wrong in [ie.shoonya.yantra.data.sync.GitHubApi]
 * and [ie.shoonya.yantra.data.sync.GitHubDeviceAuth] goes wrong at the HTTP layer — a status code
